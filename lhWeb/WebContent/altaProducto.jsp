    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="altaProducto.jsp">Entrada Almacen</a></li>
...
<!-- $$$$$$$$$$$$$$$$$$$$ -->
          ...
          <div class="form-group">          
        	...
        	<!-- Nombre -->
          <div class="form-group">          
            <input id="howMany" type="text" class="form-control" placeholder="Cantidad">
          </div>
          ...
          <!-- Proveedor -->
          <div class="form-group">            
            <input id="proveedor" type="text" class="form-control" placeholder="Proveedor">
          </div>
          ...
          <div class="form-group">
            <button id="altaSP" type="submit" class="btn btn-info">Registrar</button>
          </div>
